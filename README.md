...
- **39 道题目**：35 道为官方真题（2012 年度全国会计专业技术资格考试《中级会计实务》客观题，来源：财政部会计财务评价中心官网 kzp.mof.gov.cn 官方试题+答案 PDF，原件存于 `back-end/database/raw/`），4 道为 MVP 示例题
- 题型覆盖：单选 17、多选 11、判断 11
- 真题已标注 `source=官方真题-2012`、`year=2012`
- 扩充题库：向 `questions` 表插入题目即可（参考 `import_2012_exam.sql` 格式）；官方仅公布 2012 年真题，2013 年后官方不公开发布完整真题，培训机构的历年真题多为考生回忆版
